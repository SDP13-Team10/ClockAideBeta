...
# 4/6/13 Voice map, set mode. First successful test of voice map

import time, sys, random, sqlite3, string, usb, serial, os, datetime, re
...
def speakTime(hour,minute):
	...
	if minute == 0:
		minuteFile="./VoiceMap/Wildcards/oclock.wav"
	else:
